...
std::string GetCondition<Condition::EQ>::Get() {
    return "=";
}

std::string GetCondition<Condition::NOT_EQ>::Get() {
    return "!=";
}

std::string GetCondition<Condition::GREATER>::Get() {
    return ">";
}

std::string GetCondition<Condition::GREATER_EQ>::Get() {
    return ">=";
}

std::string GetCondition<Condition::LESS>::Get() {
    return "<";
}

std::string GetCondition<Condition::LESS_EQ>::Get() {
    return "<=";
}

std::string GetCondition<Condition::IN>::Get() {
    return "IN";
}

std::string GetCondition<Condition::NOT>::Get() {
    return "NOT";
}

std::string GetCondition<Condition::NOT_IN>::Get() {
    return "NOT IN";
}

std::string GetCondition<Condition::BETWEEN>::Get() {
    return "BETWEEN";
}

std::string GetCondition<Condition::IS>::Get() {
    return "IS";
}

std::string GetCondition<Condition::LIKE>::Get() {
    return "LIKE";
}

std::string GetCondition<Condition::EXISTS>::Get() {
    return "EXISTS";
}

std::string GetCondition<Condition::NOT_NULL>::Get() {
    return "NOT NULL";
}

std::string GetCondition<Condition::IS_NULL>::Get() {
    return "IS NULL";
}

std::string GetCondition<Condition::IS_NOT_NULL>::Get() {
    return "IS NOT NULL";
}

std::string GetCondition<Condition::NONE>::Get() {
    return "";
}
...
std::string winter::data::sql_impl::condition(enum Condition condition) {
    switch (condition) {
        ...
        case Condition::BETWEEN: return GetCondition<Condition::BETWEEN>::Get();
