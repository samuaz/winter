...
/**
 * @tparam TEntityClass is the entity class that represents and returns this repository
 * @tparam TIDType is the datatype of id PK of the entity Table, example UUID, Long, Int
 * @tparam TResultSetType is the ResultSetType returned by the mysql database connection and transaction
 */
...
class Repository {
 public:
   ...
   * @param TIDType
   * @return Response<TEntityClass> returns a winter::reponse of given TEntityClass
   */
 ...
 protected:
  ...
  /**
   * @brief Implements the logic to Generate TEntityClass from TResultSetType, unpack the TResultSetType and call the CreateEntity
  ...
  /**
   * @brief Implements the logic to Create TEntityClass from TResultSetType
   * @param TEntityClass
   * @return Response<TEntityClass>
   */
  ...
  /**
   * @brief Returns a single TEntityClass from TResultSetType, if there is a list return the first one
   * @param TResultSetType
   * @return Response<TEntityClass>
   */
  ...
  /**
   * @brief Returns a vector of TEntityClass from TResultSetType, if there is not results will return empty vector
   * @param TResultSetType
   * @return Response<TEntityClass>
   */
