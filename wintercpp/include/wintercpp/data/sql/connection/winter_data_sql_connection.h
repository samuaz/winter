...
namespace winter::data::sql_impl {
    ...
    /**
     * Interface to create basic SQL connection this is used for example on
     * winter::mysql, winter::postgres, winter::mariadb
     */
    template<typename TConnectionType, typename TResponse>
    class SQLConnection :
        public winter::templates::Connection<TConnectionType> {
       public:
        SQLConnection(const SQLConnection &) = delete;
        SQLConnection &operator=(const SQLConnection &) = delete;

        /**
         * @brief simple function that execute the prepared statement query then
         * this internally should encapsulate the logic to insert, update,
         * select, remove, etc.
        ...
        /**
         * @brief basic function that implement how to initialize the
         * transaction with his isolation level and start transaction
       ...
       public:
        explicit SQLConnection(TConnectionType *conn) :
            winter::templates::Connection<TConnectionType>(conn) {};
    };
}  // namespace winter::data::sql_impl
