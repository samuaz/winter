...
namespace winter {
    ...
    class WinterBoot {
       public:
        ...
        static void init(const std::string &host, const std::string &port, bool ssl, const std::string &servercert, const std::string &serverkey);
       ...
       private:
        WinterBoot();
        static void                        runServer(const std::string &host, const std::string &port, bool ssl, const std::string &servercert, const std::string &serverkey);
