...
execute_process(
        COMMAND bash "-c" "mkdir -p build; cd build && cmake -DCMAKE_BUILD_TYPE=Release -Dprotobuf_BUILD_TESTS=OFF -DCMAKE_INSTALL_PREFIX=${protobuf_SOURCE_DIR}/install ../cmake && make install "
        WORKING_DIRECTORY ${protobuf_SOURCE_DIR}
