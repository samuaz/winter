...
execute_process(
        COMMAND bash "-c" "mkdir -p build; cd build && cmake -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -Dprotobuf_BUILD_TESTS=OFF -DCMAKE_INSTALL_PREFIX=${protobuf_SOURCE_DIR}/install ../cmake && make -j4 && make install "
        WORKING_DIRECTORY ${protobuf_SOURCE_DIR}
...
set(Protobuf_LIBRARY ${protobuf_SOURCE_DIR}/install/lib/libprotobuf.a CACHE INTERNAL "")
set(Protobuf_PROTOC_EXECUTABLE ${protobuf_SOURCE_DIR}/install/bin/protoc CACHE INTERNAL "")
