...
#define MYSQL_RESPONSE_IMPL winter::data::sql_impl::mysql::Response<winter::data::mysql::connection::ResultRow>
...
class Response : public virtual MYSQL_RESPONSE_IMPL {
 public:
  ...
  Response(
      ...
      const string& message,
      int rowAffected) :
      MYSQL_RESPONSE_IMPL(transactionId, type, result, status, message, rowAffected) {}
};
}  // namespace winter::data::mysql
