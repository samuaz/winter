...
MESSAGE(STATUS "PROTOBUF_CUSTOM_ARG:" ${PROTOBUF_CUSTOM_ARG})
...
foreach (file ${PROTOBUF_DEFINITION_FILES})
    ...
    if (file MATCHES "service" OR file MATCHES "controller")
        MESSAGE(${file})
        execute_process(COMMAND ${PROTO_BINARY} -I ${PROTOBUF_INPUT_DIRECTORY} ${PROTOBUF_CUSTOM_ARG} --grpc_out=${PROTOBUF_OUTPUT_DIRECTORY} --plugin=protoc-gen-grpc=${GRPC_PLUGIN} ${file}
                WORKING_DIRECTORY ${CMAKE_SOURCE_DIR}
        ...
        execute_process(COMMAND ${PROTO_BINARY} -I ${PROTOBUF_INPUT_DIRECTORY} ${PROTOBUF_CUSTOM_ARG} --cpp_out=${PROTOBUF_OUTPUT_DIRECTORY} ${file}
                WORKING_DIRECTORY ${CMAKE_SOURCE_DIR}
