...
execute_process(
        ...
        WORKING_DIRECTORY ${grpc_plugin_SOURCE_DIR}
...
execute_process(
        COMMAND cmake ..
        WORKING_DIRECTORY ${grpc_plugin_SOURCE_DIR}/build
...
execute_process(
        ...
        COMMAND cp ${grpc_plugin_SOURCE_DIR}/build/grpc_cpp_plugin ${THIRD_PARTY_DIR}/grpc_plugin
        COMMAND cp ${grpc_plugin_SOURCE_DIR}/build/libgrpc_plugin_support.a ${THIRD_PARTY_DIR}/grpc_plugin
        WORKING_DIRECTORY ${grpc_plugin_SOURCE_DIR}/build
