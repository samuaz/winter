...
set(BUILD_DIRECTORY build_grpc_plugin)

# create grpc_cpp_plugin build dir
execute_process(
        COMMAND bash "-c" "mkdir ${BUILD_DIRECTORY}"
...
execute_process(
        ...
        WORKING_DIRECTORY ${grpc_SOURCE_DIR}/${BUILD_DIRECTORY}
...
# create grpc_cpp_plugin copy to thirparty dir
execute_process(
        COMMAND bash "-c" "cp ${grpc_SOURCE_DIR}/${BUILD_DIRECTORY}/grpc_cpp_plugin ${THIRD_PARTY_DIR}/grpc_plugin/"
        COMMAND bash "-c" "cp ${grpc_SOURCE_DIR}/${BUILD_DIRECTORY}/libgrpc_plugin_support.a ${THIRD_PARTY_DIR}/grpc_plugin/"
        WORKING_DIRECTORY ${grpc_SOURCE_DIR}/${BUILD_DIRECTORY}
...
FetchContent_Declare(
        protobuf_compiler
        URL https://github.com/protocolbuffers/protobuf/releases/download/v${WINTER_PROTOBUF_VERSION}/protoc-${WINTER_PROTOBUF_VERSION}-${HOST_OS}-${HOST_ARCHITECTURE}.zip
